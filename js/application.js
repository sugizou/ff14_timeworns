window.onload = function() {
  ...
  var memberAdd = new Vue({
    ...
    data: {
      ...
      imageCoordinate: "",
      areas: [
        { name: "ギラバニア辺境地帯", key: "gyr-abania-fringes" },
        { name: "ギラバニア山岳地帯", key: "gyr-abania-peaks" },
        { name: "ギラバニア湖畔地帯", key: "gyr-abania-lochs" },
        { name: "紅玉海", key: "othard-ruby-sea" },
        { name: "ヤンサ", key: "othard-yanxia" },
        { name: "アジムステップ", key: "othard-azim-steppe" }
      ],
      treasurePoints: {
        "gyr-abania-fringes": [
